      ...
      >
        ...
        <div className="flex-1">
          <div>
            <AiFillCaretRight
              fontSize={50}
              className={`${!open && "rotate-180 top-[1.3rem]"
            ...
            >
              <div
                className={`${open && "scale-x-0 absolute translate-x-28 duration-1000"
          ...
          <div className={`space-y-5 mt-7`}>
            ...
            <NavLink
              to="/dashboard/admin"
              className={`${["/dashboard/admin"].includes(pathname) ? "bg-[#33cabb] hover:bg-[#33cabb]" : "hover:bg-[#3f4a59]"} flex items-center text-white  hover:cursor-pointer py-1`}
            >
              {!open ? (
          ...
          <div className="mt-5 transition-all ease-in-out duration-1000 ">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`${openProduct && "rotate-90"
            ...
            <ul
              className={`${!openProduct && "scale-y-0 my-0 py-0 h-0"
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/category" &&
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/subcategory" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/brand" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/products" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
          ...
          <div className="transition-all duration-1000 ease-in-out z-10 overflow-hidden">
            ...
            <div
              className={`${["/dashboard/admin/orders"].includes(pathname)
                  ? "bg-[#33cabb] hover:bg-[#33cabb]" : "hover:hover:bg-[#3f4a59]"} ${openProduct && "bg-[#455160]"
                } py-1 flex items-center hover:cursor-pointer text-white`}
            ...
            <ul
              className={`${!openOrder && "max-h-0 scale-y-0"
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/orders" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
          ...
          <div className="transition-all duration-500 ease-in-out overflow-hidden z-20">
            ...
            <div
              className={`${["/dashboard/admin/users/list"].includes(pathname) ? "bg-[#33cabb] hover:bg-[#33cabb]" : "hover:hover:bg-[#3f4a59]"} ${openUser && "bg-[#455160]"
                } py-1 flex items-center hover:cursor-pointer text-white`}
            ...
            <ul
              className={`${!openUser && "scale-y-0 max-h-0"
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/users/list" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
          ...
          <div className="transition-all duration-500 ease-in-out overflow-hidden z-20">
            ...
            <div className={`${["/dashboard/admin/stocks/new" ,"/dashboard/admin/stocks/add"].includes(pathname) ? "bg-[#33cabb] hover:bg-[#33cabb]" : "hover:bg-[#3f4a59]"} ${openStock && "bg-[#455160]"} py-1 flex items-center hover:cursor-pointer text-white`}
            ...
            <ul
              className={`${!openStock && "scale-y-0 max-h-0"
                } transition-all duration-700 ease-in-out origin-top bg-[#505b6996]`}
            >
              <li>
                <NavLink
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/stocks/add" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/stocks/new" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
          ...
          <div className="transition-all duration-500 ease-in-out overflow-hidden z-20">
            ...
            <div className={`${["/dashboard/admin/stocks/newsadasd"].includes(pathname) ? "bg-[#33cabb] hover:bg-[#33cabb]" : "hover:bg-[#3f4a59]"} ${openStock && "bg-[#455160]"} py-1 flex items-center hover:cursor-pointer text-white`}
              ...
              <li>
                ...
                >
                  ...
                  <div className={`${open ? "mx-auto" : "mr-5"}`}>
                    <BiCircle
                      fontSize={10}
                      className={`${pathname === "/dashboard/admin/stocks/newasds" &&
                        "text-[#33cabb] bg-[#33cabb]"
                        } rounded-full`}
                    />
                  </div>
