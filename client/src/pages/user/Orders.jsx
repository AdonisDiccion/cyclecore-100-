...
export default function UserOrders() {
  ...
  const handlePrint = () => {
    window.print();
    document.title = "order#: " + selectedOrder.id;
  };
  ...
  return (
    <div className={`${orders.length > 1 ? "h-full" : "h-screen"} bg-gray-200 h-screen py-5 px-10`}>
      <Navbar />
      ...
      >
              ...
              <div className="font-bebas flex justify-between mt-4">
                ...
                <div className="space-y-1">
                  <div className="text-sm">
                    ...
                    {selectedOrder.payment?.transaction?.creditCard?.cardType ? selectedOrder.payment?.transaction?.creditCard?.cardType : 'Cash-On-Delivery' }
                    </span>
                  </div>
                  <div className="text-sm">
                    Card Type:{" "}
        ...
        <div className="flex justify-between">
          <DialogTitle
            sx={{ height: "100px", backgroundColor: "gray", width: "76.8%" }}
          >
            <div className="font-bebas">
              ...
              <>
                <div>
                  ...
                  <h1 className="font-bebas text-2xl justify-end flex text-white">
                    {selectedOrder.totalPrice.toLocaleString("en-PH" ,{style: "currency", currency: "PHP"})}
                  </h1>
                </div>
              </>
            )}
