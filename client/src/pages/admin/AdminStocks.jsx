  ...
  return (
    <div>
            ...
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="flex items-center justify-between p-2">
                ...
                <button
                  ...
                  onClick={() =>  {setConfirm(true); showDialog(null)}}
                >
                  <AiOutlineStock />
                  Add Stocks
                </button>
      ...
      <Dialog open={confirm} onClose={() => setConfirm(false)}>
        <DialogTitle><span>Add Stock</span></DialogTitle>
        <DialogContent><span>Are You Sure To Add this stocks?</span></DialogContent>
        <DialogActions>
          <div className="flex justify-between">
            <button onClick={() => {handleAddStocks();setConfirm(false);}}>Yes</button>
